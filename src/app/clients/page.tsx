  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <p className="text-lg mb-8">
        ...
        Our commitment to excellence has earned us the trust of these distinguished organizations.
      </p>
      ...
      <div className="mt-12">
        ...
        <p className="text-lg">
          Join our growing list of satisfied clients. Contact us today to discuss how we can help with your engineering needs.
        </p>
      </div>
    </div>
  );
